...
const QUICK_USERS = [
  { label: '👑 Super Admin', email: 'superadmin@scms.edu', password: 'Admin@123' },
  { label: '💻 IT Admin', email: 'it.admin@scms.edu', password: 'Admin@123' },
  { label: '⚡ Maintenance Admin', email: 'maint.admin@scms.edu', password: 'Admin@123' },
]
